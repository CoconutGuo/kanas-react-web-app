...
function EncodingParametersInURLs() {
  ...
  return (
    <div>
      ...
      <h4>Calculator</h4>
      <input onChange={(e) => setA(e.target.value)} className="form-control mb-2" type="number" value={a} />
      <input onChange={(e) => setB(e.target.value)} className="form-control mb-2" type="number" value={b} />
      ...
      <a href={`http://localhost:4000/a5/calculator?operation=add&a=${a}&b=${b}`} className="btn btn-primary  me-2">
        Add {a} + {b}
      </a>
