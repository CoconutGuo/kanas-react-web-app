...
import { BsTrash3Fill, BsPencil, BsFillCheckCircleFill, BsPlusCircleFill } from 'react-icons/bs'
      ...
      <table className="table">
        <thead>
          ...
          <tr>
            ...
            <td className='d-flex'>
              <input className="form-control me-2" value={user.lastName} onChange={(e) => setUser({ ...user, lastName: e.target.value })} />
            {/* </td> */}
            {/* <td> */}
